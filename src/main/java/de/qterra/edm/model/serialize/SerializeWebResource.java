...
public class SerializeWebResource implements WebResource{
  ...
  private ArrayList<SerializeResourceAttribute> dctermsIsReferencedBy = new ArrayList<>();
  private SerializeResourceAttribute edmIsNextInSequence = new SerializeResourceAttribute();
 ...
 public void setDcType(ArrayList<String> type) {
  ...
  public void setEdmIsNextInSequence(ResourceAttribute edmIsNextInSequence) {
    this.edmIsNextInSequence = (SerializeResourceAttribute) edmIsNextInSequence;
